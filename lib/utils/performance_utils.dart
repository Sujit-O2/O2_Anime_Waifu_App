...
class AppTextStyles {
  ...
  static final TextStyle outfit12w500 =
      GoogleFonts.outfit(fontSize: 12, fontWeight: FontWeight.w500);
  static final TextStyle outfit12w600 =
      GoogleFonts.outfit(fontSize: 12, fontWeight: FontWeight.w600);
  static final TextStyle outfit12w700 =
      GoogleFonts.outfit(fontSize: 12, fontWeight: FontWeight.w700);
  static final TextStyle outfit13w600 =
      GoogleFonts.outfit(fontSize: 13, fontWeight: FontWeight.w600);
  static final TextStyle outfit14w400 =
      GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w400);
  static final TextStyle outfit14w600 =
      GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w600);
  static final TextStyle outfit14w800 =
      GoogleFonts.outfit(fontSize: 14, fontWeight: FontWeight.w800);
  static final TextStyle outfit16w600 =
      GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.w600);
  static final TextStyle outfit16w800 =
      GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.w800);
  static final TextStyle outfit18w700 =
      GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.w700);
  static final TextStyle outfit20w900 =
      GoogleFonts.outfit(fontSize: 20, fontWeight: FontWeight.w900);
  static final TextStyle outfit22w900 =
      GoogleFonts.outfit(fontSize: 22, fontWeight: FontWeight.w900);
  static final TextStyle outfit52w800 = GoogleFonts.outfit(
      fontSize: 52, fontWeight: FontWeight.w800, letterSpacing: -2);

  // Color variants
  static final TextStyle outfit14White =
      GoogleFonts.outfit(color: Colors.white, fontSize: 14);
  static final TextStyle outfit12White70 =
      GoogleFonts.outfit(color: Colors.white70, fontSize: 12);
  static final TextStyle outfit12White54 =
      GoogleFonts.outfit(color: Colors.white54, fontSize: 12);
  static final TextStyle outfit16White600 = GoogleFonts.outfit(
      color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600);
  static final TextStyle outfit18White700 = GoogleFonts.outfit(
