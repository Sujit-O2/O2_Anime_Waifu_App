        ...
        child: Column(
          ...
          children: [
            ...
            _debugStatusCard(
              ...
              color:
                  _notificationsAllowed ? Colors.greenAccent : Colors.redAccent,
            ...
            _debugStatusCard(
              ...
              color:
                  _assistantModeEnabled ? Colors.greenAccent : Colors.white38,
            ...
            _debugStatusCard(
              label: 'Idle Timer',
              status: _idleTimer?.isActive == true ? 'Active' : 'Inactive',
            ...
            Wrap(
              ...
              children: [
                ...
                _debugActionBtn('Test TTS', Icons.volume_up,
                    () => _ttsService.speak("Hello Darling, systems online!")),
