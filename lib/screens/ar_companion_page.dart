...
class _ArCompanionPageState extends State<ArCompanionPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _sendToWidget() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${model.name} locked into Home Screen widget! \n(Restart app to initialize Android broadcast receiver)'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // â”€â”€ 3D VIEWER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          Expanded(
            flex: 5,
            child: Stack(
              fit: StackFit.expand,
              children: [
                ...
                ClipRRect(
                  ...
                  child: ModelViewer(
                    key: ValueKey('${model.url}_$_autoRotate'), // Force full rebuild to stop rotation instantly
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text('Pinch to zoom â€¢ Drag to rotate â€¢ Tap AR icon to project',
                    ...
                    child: AnimatedBuilder(
                      ...
                      builder: (context, child) => Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: model.color.withValues(alpha: 0.15 + _pulseCtrl.value * 0.05),
                          border: Border.all(color: model.color.withValues(alpha: 0.4)),
                          boxShadow: [
                            BoxShadow(color: model.color.withValues(alpha: 0.15 + _pulseCtrl.value * 0.1), blurRadius: 20),
                          ],
                        ),
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(model.name.toUpperCase(),
                              style: GoogleFonts.outfit(
                                color: Colors.white, fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 1.5)),
                            const SizedBox(width: 8),
                            Container(
                              width: 6, height: 6,
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [BoxShadow(color: Colors.greenAccent.withValues(alpha: 0.5 + _pulseCtrl.value * 0.5), blurRadius: 8)],
                              ),
                            ),
                          ],
                        ),
          ...
          // â”€â”€ MODEL GALLERY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          Container(
              ...
              children: [
                Padding(
                  ...
                  child: Text('MODEL GALLERY',
                    style: GoogleFonts.outfit(
                      color: Colors.white38, fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 2)),
                ),
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              colors: selected
                                  ? [m.color.withValues(alpha: 0.25), m.color.withValues(alpha: 0.08)]
                                  : [Colors.white.withValues(alpha: 0.04), Colors.white.withValues(alpha: 0.02)],
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            ),
                            border: Border.all(
                              color: selected ? m.color.withValues(alpha: 0.6) : Colors.white.withValues(alpha: 0.06),
                              width: selected ? 1.5 : 1,
                            ),
                            boxShadow: selected
                                ? [BoxShadow(color: m.color.withValues(alpha: 0.2), blurRadius: 16, spreadRadius: -2)]
                                : null,
                          ),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(m.icon, color: selected ? m.color : Colors.white30, size: 18),
                                  if (selected) ...[
                                    const Spacer(),
                                    Container(
                                      ...
                                      child: Text('LIVE', style: GoogleFonts.jetBrainsMono(
                                        color: m.color, fontSize: 7, fontWeight: FontWeight.w900, letterSpacing: 1)),
                                    ),
                                  ],
                                ],
                              ),
          ...
          // â”€â”€ ACTION COMMANDS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          Container(
                  ...
                  children: [
                    Expanded(
                      child: _buildActionButton(
                        ...
                        _autoRotate ? Icons.pause_circle_filled_rounded : Icons.play_circle_filled_rounded,
                    ...
                    Expanded(
                      child: _buildActionButton(
                        ...
                        () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Tap the AR icon on the 3D viewer above!',
                                style: GoogleFonts.outfit(fontSize: 12)),
                              backgroundColor: model.color.withValues(alpha: 0.9),
                            ),
                          );
                        },
                      ),
