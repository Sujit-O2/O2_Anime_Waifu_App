...
class _ImagePackPageState extends State<ImagePackPage>
  ...
  Future<void> _loadData() async {
    ...
    if (packsJson != null) {
      ...
      _allPacks = [
        ImagePack(
            name: 'Anime Waifu 1',
            previewUrl: 'https://example.com/waifu1.jpg',
            description: 'Beautiful anime waifu backgrounds'),
        ImagePack(
            name: 'Cyberpunk',
            previewUrl: 'https://example.com/cyber.jpg',
            description: 'Futuristic cyberpunk themes'),
        ImagePack(
            name: 'Nature',
            previewUrl: 'https://example.com/nature.jpg',
            description: 'Serene nature landscapes'),
      ];
    }
  ...
  void _filterPacks(String query) {
    if (!mounted) return;
    setState(() {
      _filteredPacks = _allPacks
          .where(
              (pack) => pack.name.toLowerCase().contains(query.toLowerCase()))
          .toList();
    });
  }
  ...
  void _showAICommentary(ImagePack pack) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text('AI Commentary',
            style: GoogleFonts.outfit(color: Colors.white)),
        content: Text(
            'This ${pack.name} pack brings a ${pack.description}. It\'s been used ${pack.usage} times!',
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: BarChart(
                  BarChartData(
                    barGroups: _filteredPacks
                        .map((pack) => BarChartGroupData(
                              x: _filteredPacks.indexOf(pack),
                              barRods: [
                                BarChartRodData(
                                    toY: pack.usage.toDouble(),
                      ...
                      bottomTitles: AxisTitles(
                        sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) => Text(
                              _filteredPacks[value.toInt()].name,
                              style: GoogleFonts.outfit(
              ...
              Container(
                ...
                child: _currentBgUrl == null
                    ? Center(
                        child: Text('Default Animated Gradient',
