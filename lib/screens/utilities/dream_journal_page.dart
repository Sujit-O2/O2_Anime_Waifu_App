...
class _DreamJournalPageState extends State<DreamJournalPage>
  ...
  void initState() {
    super.initState();
    unawaited(AppDB.instance.recordUsage('dream_journal'));
  ...
  Widget build(BuildContext context) {
    return FeaturePageV2(
      title: 'DREAM JOURNAL',
      subtitle: '${_entries.length} dreams logged',
      ...
      actions: [
        ...
        GestureDetector(
            ...
            child: Container(
              ...
              child: const Icon(Icons.add_rounded, color: Colors.purpleAccent, size: 20),
            )),
      ],
      content: _loading
          ? const Center(
          ...
          : _entries.isEmpty
              ? Center(
                  child: Column(
                      ...
                      children: [
                      const Icon(Icons.nightlight_round, color: Colors.purpleAccent, size: 48),
