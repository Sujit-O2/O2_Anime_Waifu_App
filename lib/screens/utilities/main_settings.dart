...
// —— Page: Settings ————————————————————————————————————————————————————————————————
  ...
  Widget _buildSettingsV2Overview(Color primary) {
    final activeAutomation = <bool>[
    ...
    final mood = activeAutomation >= 4
        ...
        : activeAutomation >= 2
            ...
            : _liteModeEnabled
                ? 'relaxed'
                : 'neutral';
    final personaLabel = _selectedPersona == 'Default'
        ? 'ZT'
        : _selectedPersona.split(' ').first;
        ...
        Row(
          children: [
            ...
            Expanded(
              child: StatCard(
                title: 'Voice',
                value: _dualVoiceEnabled ? 'Dual' : 'Solo',
        ...
        Row(
          children: [
            Expanded(
              child: StatCard(
                title: 'STT',
                value: _sttProvider == 'gladia' ? 'Live' : 'Batch',
                ...
                children: [
                  ...
                  _settingsSectionCard('VOICE & ASSISTANT', [
                    ...
                    _settingsTile(
                      ...
                      subtitle: _sp.trueBackgroundProactiveEnabled
                          ? 'Checks in even when app is killed'
                          : 'Only when running/foreground',
                      value: _sp.trueBackgroundProactiveEnabled,
                      onChanged: (_) =>
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (!_proactiveRandomEnabled) ...[
                                    ...
                                    Slider(
                                      value:
                                          _proactiveIntervalSeconds.toDouble(),
                                      min: 60,
                                      max: 18000,
                                      divisions: 299,
                                      onChanged: (v) =>
                  ...
                  const SizedBox(height: 16),
                  _settingsSectionCard('THEME & APPEARANCE', [
                    _buildToolShortcut(
