...
class _ClipboardManagerPageState extends State<ClipboardManagerPage> {
  ...
  void initState() {
    super.initState();
    unawaited(AppDB.instance.recordUsage('clipboard_manager'));
    _load();
  }
        ...
        Expanded(
          child: filtered.isEmpty
              ? const EmptyState(
                  ...
                  subtitle: 'Save text, links, or emails to quickly access them later.',
                )
              : ListView.builder(
                  ...
                  itemBuilder: (ctx, i) {
                    ...
                    return Dismissible(
                      ...
                      child: AnimatedEntry(
                        index: (i < 10 ? i : 1), // Cascade first 10 items
