...
class _PoemGeneratorPageState extends State<PoemGeneratorPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _ctrlAnim = AnimationController(vsync: this, duration: const Duration(milliseconds: 700))..forward();
  }
  final _styles = [
    '💫 Haiku',
    '📜 Sonnet',
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: SlideTransition(
          position: Tween<Offset>(begin: const Offset(0, 0.05), end: Offset.zero).animate(CurvedAnimation(parent: _ctrlAnim, curve: Curves.easeOutCubic)),
