...
class _WordPuzzlePageState extends State<WordPuzzlePage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _saveStats() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setInt('word_puzzle_best_streak_v2', _bestStreak);
    await prefs.setInt('word_puzzle_wins_v2', _wins);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SlideTransition(
        position: Tween<Offset>(begin: const Offset(0, 0.05), end: Offset.zero).animate(CurvedAnimation(parent: _ctrl, curve: Curves.easeOutCubic)),
        child: FadeTransition(
          ...
          Row(children: [
            Expanded(child: _statCard('Wins', '$_wins', Colors.greenAccent)),
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Center(
                          child: Text(l,
                              style: GoogleFonts.outfit(
                                  color: guessed ? Colors.white24 : Colors.white,
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold))),
                    ),
                  );
