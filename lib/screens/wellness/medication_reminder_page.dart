...
class _MedicationReminderPageState extends State<MedicationReminderPage>
  ...
  Future<void> _load() async {
    ...
    try {
      _meds = (jsonDecode(p.getString('medication_data') ?? '[]') as List)
  ...
  bool _isTakenToday(int i) =>
      List<String>.from(_meds[i]['taken'] ?? []).contains(_today);

  void _addWater() {
    if (_waterGlasses >= _waterGoal) return;
    HapticFeedback.lightImpact();
  ...
  Widget build(BuildContext context) {
    final waterPct =
        _waterGoal > 0 ? (_waterGlasses / _waterGoal).clamp(0.0, 1.0) : 0.0;
    return Scaffold(
        ...
        Expanded(
          ...
          child: Column(children: [
            ...
            if (_meds.isEmpty)
              ...
              ...List.generate(_meds.length, (i) => _buildMedTile(i)),
          ]),
        )),
      ])),
    );
          ...
          Row(children: [
            ...
            Expanded(
                child: Column(
                  ...
                  Text('$_waterGlasses / $_waterGoal glasses',
                      style: GoogleFonts.outfit(
              ...
              children: List.generate(_waterGoal, (i) {
                ...
                return AnimatedContainer(
                  ...
                  child: Icon(Icons.local_drink_rounded,
                      color: filled ? Colors.cyanAccent : Colors.white12,
                      size: 16),
                );
              })),
          ...
          ClipRRect(
              ...
              child: AnimatedBuilder(
                  ...
                  builder: (_, __) => LinearProgressIndicator(
                      value: waterPct * _ringCtrl.value,
      ...
      child: Row(children: [
        GestureDetector(
            ...
            child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: taken ? Colors.greenAccent : Colors.white24)),
        ...
        Expanded(
          ...
          Text(med['name']?.toString() ?? '',
              style: GoogleFonts.outfit(
                  color: taken ? Colors.greenAccent : Colors.white,
                  fontSize: 14,
                  fontWeight: FontWeight.w700,
