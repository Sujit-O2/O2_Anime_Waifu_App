...
class _MoodTrackerPageState extends State<MoodTrackerPage>
  ...
  void initState() {
    super.initState();
    unawaited(AppDB.instance.recordUsage('mood_tracker'));
  ...
  Future<void> _saveEntry() async {
    ...
    _snack('Mood saved to your journal.');
  }
                    ...
                    children: [
                      Text('MOOD TRACKER',
                          style: GoogleFonts.outfit(
                              ...
                              letterSpacing: 1.5)),
                      Text('${_entries.length} entries synced to your timeline',
                          style: GoogleFonts.outfit(
                ...
                GlassCard(
                  ...
                  child: Row(
                    children: [
                          ...
                          children: [
                            ...
                            Text(
                              _selectedMood < 0
                                  ...
                                  : 'Ready to log $_selectedMoodLabel',
                              style: GoogleFonts.outfit(
                                color: Colors.white,
                                fontSize: 20,
                            ...
                            Text(
                              _entries.isEmpty
                                  ? 'Start your first mood entry and build a clearer emotional history over time.'
                                  : 'You logged $_weeklyEntries entries in the last 7 days. Short notes help the pattern make sense later.',
                              style: GoogleFonts.outfit(
                      ...
                      ProgressRing(
                        progress: (_entries.length.clamp(0, 14)) / 14,
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              _selectedMood < 0
                                  ? '🙂'
                                  : _moods[_selectedMood]['emoji'].toString(),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide: BorderSide(
                        color: V2Theme.primaryColor.withValues(alpha: 0.5)),
                  ),
                  contentPadding:
            ...
            child: _loading
                ...
                : _entries.isEmpty
                    ? const EmptyState(
                        ...
                        subtitle:
                            'Log your first mood entry and this screen will start building your emotional timeline.')
                    : FadeTransition(
                        opacity: _fadeCtrl,
