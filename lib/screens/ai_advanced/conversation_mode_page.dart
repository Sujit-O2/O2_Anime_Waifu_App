    ...
    return FeaturePageV2(
      ...
      content: ListView(
        ...
        children: [
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(_service.getSystemPromptModifier(),
                          style: GoogleFonts.outfit(
          ...
          AnimatedEntry(
            ...
            child: Row(children: [
              Expanded(
                  child: StatCard(
                      title: 'Modes',
                      value: '${ConversationMode.values.length}',
                      icon: Icons.chat_bubble_rounded,
                      color: theme.colorScheme.primary)),
              Expanded(
                  child: StatCard(
                      title: 'Active',
                      value: _current.emoji,
                      icon: _iconFor(_current),
                      color: activeColor)),
              Expanded(
                  child: StatCard(
                      title: 'Style',
          ...
          // ── Waifu commentary ─────────────────────────────────────────────
          const AnimatedEntry(
              index: 2, child: WaifuCommentary(mood: 'neutral')),
                  ...
                  child: Row(children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          color:
                              color.withValues(alpha: isActive ? 0.2 : 0.08)),
                    ...
                    Expanded(
                        child: Column(
                          ...
                          Text(_service.getModeDescriptionFor(mode),
                              style: GoogleFonts.outfit(
